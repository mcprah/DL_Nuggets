...
const Home = () => {
  ...
  return (
    <AdminLayout>
      ...
      <div className="relative w-full h-screen lg:h-[87vh] flex flex-col items-center px-4 py-8 mt-4 rounded-xl text-white overflow-hidden">
        {/* Dark Overlay */}
        <div className="relative z-10 flex flex-col items-center w-full">
          ...
          <div className="text-center mb-6">
            ...
            <Button
              className="mt-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-6 py-2 rounded-lg font-montserrat transition-transform transform hover:scale-105"
          ...
          <div className="w-full max-w-3xl">
            ...
            <div className="mt-6 p-6 rounded-xl text-center max-w-3xl shadow-md transition-all duration-300 hover:shadow-lg hover:scale-105">
              <p className="text-lg font-bold text-black">
                Explore Cases and Laws
              </p>
              <Button
                className="mt-2 bg-gradient-to-r from-indigo-700 to-blue-900 text-white px-4 py-2 rounded-lg transition-transform transform hover:scale-105"
