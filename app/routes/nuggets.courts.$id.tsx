...
const data = [
  {
    ...
    category: "areaOfLaw",
    details:
      "Accident law covers cases involving personal injury, liability, and negligence.",
  },
  {
    id: 2,
    ...
    category: "areaOfLaw",
    details:
      "Resolving disputes outside courts through mediation or arbitration.",
  },
  {
    id: 3,
    name: "Arbitration",
    category: "areaOfLaw",
    details: "A legally binding alternative to court trials.",
  },
];
...
const subNuggets = {
  1: [
    {
      title: "Agency - Contract Procured by Agent",
      description: "Commencement of action against agent and principal.",
      source:
        "REPUBLIC BANK (GH) LIMITED vs. GLOBAL MOTORS TRADING CO. LTD, NARESWA MOIRANTH...",
    },
    {
      title: "Agency - Duties of an Agent",
      description: "Exploring fiduciary responsibilities of an agent.",
      source: "SMITH vs. DOE & Co. LTD.",
    },
  ],
  2: [
    {
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="font-montserrat font-bold text-xl">
            {nuggetDetails?.name || "Nugget Details"}
          </p>
        </div>
...
export const loader: LoaderFunction = async ({ params }) => {
  ...
  try {
    const response = await axios.get(`${baseUrl}/judges/${id}`);
    return {
